# Generated by Powerlevel10k configuration wizard on 2020-06-25 at 23:41 EDT.
...
() {
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_DIR_PREFIX='%F{010}'
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%B%F{051}%n%F{010}@%m%F{000}'
